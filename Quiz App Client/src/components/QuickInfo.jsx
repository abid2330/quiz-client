...
const QuickInfo = () => {
    return (
        <>
            <WhoUsesTitle>Who uses <b>PPWQ</b></WhoUsesTitle>
            <Container>
                <Section>
                    <Image><Person style={{ fontSize: "180px", color: "skyblue" }} /></Image>
                    <Info>
                ...
                <Section>
                    <Image><School style={{ fontSize: "180px", color: "skyblue" }} /></Image>
                    <Info>
                ...
                <Section>
                    <Image><Group style={{ fontSize: "180px", color: "skyblue" }} /></Image>
                    <Info>
